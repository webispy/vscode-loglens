        ...
        this.context.subscriptions.push(vscode.commands.registerCommand(Constants.Commands.CollapseAllWordGroups, async () => {
            ...
            if (wordGroups.length > 0) {
                try {
                    ...
                    await vscode.commands.executeCommand(`workbench.actions.treeView.${Constants.Views.Filters}.collapseAll`);
                } catch (e) {
        ...
        this.context.subscriptions.push(vscode.commands.registerCommand(Constants.Commands.CollapseAllRegexGroups, async () => {
            ...
            if (regexGroups.length > 0) {
                try {
                    ...
                    // Call the view-specific collapse command generated by showCollapseAll: true
                    await vscode.commands.executeCommand(`workbench.actions.treeView.${Constants.Views.RegexFilters}.collapseAll`);
                } catch (e) {
                    this.logger.warn(`Failed to execute native collapse: ${e}`);
                }
            }
